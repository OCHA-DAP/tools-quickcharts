...
import { ContentToplineComponent } from './content/content-topline/content-topline.component';
...
describe('Component: Bite', () => {
  ...
  beforeEach( async(() => {
    TestBed.configureTestingModule({
        declarations: [ BiteComponent, InlineEditComponent, ContentChartComponent, ContentToplineComponent ]
      })
