.. Quick Charts documentation master file, created by
   sphinx-quickstart on Thu Feb  2 07:58:03 2017.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to the Quick Charts documentation!
==========================================
...
This dashboard is produced by the Quick Charts.
...
.. toctree::
   ...
   src/app/bites/bites
   src/app/bites/bite-list/bite-list
   src/app/bites/bite/bite
   src/app/bites/bite/content/content-chart/content-chart
   src/app/bites/bite/content/content-topline/content-topline
   build-docs
